...
public class ChessMatch {
	...
	private ChessPiece newPiece(String type, Color color) {
		...
		else if (type.equals("R")) return new Rook(board, color);
	...
	private Piece makeMove(Position source, Position target) {
		...
		if (piece instanceof Pawn && source.getColumn() != target.getColumn() && capturedPiece == null) {
			...
			if (piece.getColor() == Color.WHITE) posPawn = new Position(target.getRow() + 1, target.getColumn());
			else posPawn = new Position(target.getRow() - 1, target.getColumn());
	...
	private void undoMove(Position source, Position target, Piece capturedPiece) {
		...
		if (piece instanceof Pawn && source.getColumn() != target.getColumn() && capturedPiece == enPassantVulnerable) {
			...
			if (piece.getColor() == Color.WHITE) posPawn = new Position(3, target.getColumn());
			else posPawn = new Position(4, target.getColumn());
